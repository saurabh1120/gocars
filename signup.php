	...
	<section class="">
		...
		?>
			...
			<section class="caption">
				<h2 class="caption" style="text-align: center">Driving cars like its yours</h2>
				<h3 class="properties" style="text-align: center">Maruti suzuki- Hyundai - Nissan - Mahindra - Toyota</h3>
			</section>
	...
	<footer>
		<div class="wrapper footer">
		 ...
		 <div class="copyrights wrapper">
			<!-- Copyright &copy; 
			<?php echo date("Y")?> Simple Car Rental System -->
		</div> 
	</footer><!--  end footer  -->
